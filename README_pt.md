...
<a href="https://play.google.com/store/apps/details?id=com.fbnolvr.noya2" target="_blank"><img src="img/GetItOnGooglePlay_Badge_Web_color_Portuguese-Brazil.png" alt="Baixe o NOYA no Google Play"  style="height: 50px !important;width: 168px !important;" ></a>
...
2. Gerar uma keystore para assinar o app;

3. Colocar o arquivo jks no diretório /android/app do projeto;

4. Criar o arquivo key.properties no diretório /android do projeto;

5. Executar (individualmente) os seguintes comandos no diretório raiz do projeto:
```
flutter clean
flutter pub get

...
class AppTheme {
  ...
  static ColorScheme lightScheme() {
    return const ColorScheme(
      ...
      primaryContainer: Color(0xFFb0cddb),
      onPrimaryContainer: Color(0xFF385563),
      ...
      inversePrimary: Color(0xFF4c6977),
      primaryFixed: Color(0xFFb0cddb),
      onPrimaryFixed: Color(0xFF24414f),
      primaryFixedDim: Color(0xFF9cb9c7),
      onPrimaryFixedVariant: Color(0xFF4c6977),
      secondaryFixed: Color(0xFFffff89),
      onSecondaryFixed: Color(0xFF91a000),
      secondaryFixedDim: Color(0xFFffff75),
      onSecondaryFixedVariant: Color(0xFFb9c825),
      tertiaryFixed: Color(0xFFffff89),
      onTertiaryFixed: Color(0xFF91a000),
      tertiaryFixedDim: Color(0xFFffff75),
      onTertiaryFixedVariant: Color(0xFFb9c825),
  ...
  static ColorScheme darkScheme() {
    return const ColorScheme(
      ...
      primary: Color(0xFF4c6977),
      surfaceTint: Color(0xFF4c6977),
      onPrimary: Color(0xFFFFFFFF),
      primaryContainer: Color(0xFF24414f),
      onPrimaryContainer: Color(0xFFFFFFFF),
      secondary: Color(0xFFb9c825),
      onSecondary: Color(0xFF000000),
      secondaryContainer: Color(0xFF91a000),
      onSecondaryContainer: Color(0xFF000000),
      tertiary: Color(0xFFb9c825),
      onTertiary: Color(0xFF000000),
      tertiaryContainer: Color(0xFF91a000),
